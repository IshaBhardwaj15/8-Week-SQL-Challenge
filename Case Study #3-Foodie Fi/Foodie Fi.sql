--Created a new database called "foodie_fi", now using the same databse to insert and create new tables and further queries
use foodie_fi
go

--Creating a new schema called "foodie_fi"
create schema foodie_fi
go

--Creating table called "plans"
...
--Creating table called "subscriptions"
...
--Inserting data in subcriptions in parts as ms sql only allows 1000 rows to inserted in insert into statement
--first 1000 rows 
insert into foodie_fi.subscriptions
  (customer_id, plan_id, sstart_date)
values
  ('1', '0', '2020-08-01'),
  ('1', '1', '2020-08-08'),
  ('2', '0', '2020-09-20'),
...
--seeing how our tables look like
...
--Query 1 Based off the 8 sample customers provided in the sample from the subscriptions table, write a brief description 
...
--Query 2 What is the monthly distribution of trial plan start_date values for our dataset - use the start of the month as 
--the group by value
...
--Query 3 What plan start_date values occur after the year 2020 for our dataset? Show the breakdown by count of events for 
--each plan_name
...
--Query 5 How many customers have churned straight after their initial free trial - what percentage is this rounded to 
